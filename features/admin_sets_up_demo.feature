Feature: Admin sets up demo
  ...
  Scenario: Admin sets up demo
    ...
    And I set the start time to "April/1/2011/12 PM/00"
    And I set the end time to "May/1/2012/12 PM/00"
    ...
    And I should see "Game begins at April 01, 2011 at 12:00 PM Eastern"
