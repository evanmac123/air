Feature: User requests help
  ...
  Scenario: During business hours
    ...
    Then "+14155551212" should have received SMS "Got it. We'll have someone get back to you shortly. Tech support is open 9 AM to 9 PM ET. If it's outside those hours, we'll follow-up first thing when we open."  
    And "+14155551213" should have received SMS "Got it. We'll have someone get back to you shortly. Tech support is open 9 AM to 9 PM ET. If it's outside those hours, we'll follow-up first thing when we open."  
