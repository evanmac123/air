Feature: User requests help
  ...
  Scenario: During business hours
    ...
    Then "+14155551212" should have received SMS "Got it. We'll have someone get back to you shortly."
    And "+14155551213" should have received SMS "Got it. We'll have someone get back to you shortly."
  ...
  Scenario: After business hours
    ...
    And "+14155551213" sends SMS "help"
    Then "+14155551212" should have received SMS "Got it. We'll have someone get back to you during our business hours, 9 AM to 9 PM Eastern time."
    And "+14155551213" should have received SMS "Got it. We'll have someone get back to you during our business hours, 9 AM to 9 PM Eastern time."
