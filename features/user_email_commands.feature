Feature: User acts via email
  ...
  Scenario: User can send in email commands and have them processed correctly
    ...
    And "dan@bigco.com" have an email command history with the phrase "Bananas are good for you. Points 2/20."
    When "dan@bigco.com" opens the email
    Then I should see "Bananas are good for you. Points 2/20." in the email body

    Given a clear email queue

  	When "dan@bigco.com" sends email with subject "me tarzan, you jane" and body "ate banana"
    Then "dan@bigco.com" have an email command history with the phrase "Bananas are good for you. Points 4/20."
    When "dan@bigco.com" opens the email
    Then I should see "Bananas are good for you. Points 4/20." in the email body
...
"""
    Then "dan@bigco.com" have an email command history with the phrase "Bananas are good for you. Points 2/20."
