# The astute among you will notice that the style of the code in this file is
# different from the rest of the codebase. This is because, in the latest
# version of FactoryGirl, Thoughtbot took out the built-in Cucumber steps. I
...
#
# However, I think that the way they suggest writing Cucumber scenarios in
# this article is also wildly problematic, plus I hate the living ass out of
# Cucumber anyway, so we're sticking to our policy of gradually killing off
# Cucumber features by attrition.
#
