...
(function() {
  ...
  $.fn.extend({
    confirmWithReveal: function(options) {
      //Adds support for option to modify the order of the confirm and cancel
      //buttons
      var defaults, do_confirm, handler, settings, button_adder;
      if (options == null) {
        options = {};
      }
      defaults = {
        ...
        reverse_buttons: false, //boolean to determine whether to reorder buttons
      };
      ...
      do_confirm = function($el) {
        ...
        modal.find('[data-confirm-cancel]').html(option('cancel')).on('click', function(e) {
         ...
         //if reverse_buttons is set true (default is false) then prepend the
        //confirm button rather than appending.
