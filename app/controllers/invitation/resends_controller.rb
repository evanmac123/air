class Invitation::ResendsController < ApplicationController
  ...
  def create
    ...
    if user
      ...
      flash[:notice] = %{It looks like you haven't been invited yet. You can request an invitation <a href="#{new_invitation_path}">here</a>, or contact <a href="mailto:support@hengage.com">support@hengage.com</a> for help."}
    end
