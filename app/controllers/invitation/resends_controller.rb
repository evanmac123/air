  ...
  def create
    ...
    if user
      if user.accepted_invitation_at.nil?
        ...
        flash[:failure] = "It looks like you've already joined the game. You can log in <a href=\"#{new_session_path}\">here</a>, or if you've forgotten your password, you can reset it <a href=\"#{new_password_path}\">here</a>."
      end
    else
