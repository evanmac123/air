...
Airbo.Highcharts.stackedBarGraphTemplate = function($chart){
  ...
  return {
    ...
    plotOptions: $.extend(Airbo.Highcharts.PlotOptions.defaultPlotOptions($chart), {  column: { stacking: 'normal' } }),
    series: series,
    tooltip: Airbo.Highcharts.CustomTooltips.SharedTooltipWithPercentOfWhole.render($chart)
  };
};
