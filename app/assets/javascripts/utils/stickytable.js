  ...
  function initTable(){
    ...
    $('table.sticky').each(function() {
      ...
      if(table.find('thead').length > 0 && table.find('th').length > 0) {
        ...
        var setWidths = function () {
         table 
          .find('thead th').each(function (i) {
            $stickyHead.find('th').eq(i).width(table.width());
          })
          .end()
          .find('tr').each(function (i) {
            $stickyCol.find('tr').eq(i).height(table.height());
          });
        ...
        table.parent('.sticky-wrap').scroll($.throttle(250, function() {
