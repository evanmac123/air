...
function saveDraft() {
  $("form[class$='_raffle']")
    .attr("action", "/client_admin/prizes/save_draft")
...
function startLive() {
  ...
  $("form[class$='_raffle']")
    .attr("action", "/client_admin/prizes/start")
...
function updatePreviewDuration() {
  ...
  if (!duration) {
    ...
    second_date_num =
      Math.floor(duration / dayDuration()) -
    ...
    second_date_num =
      Math.floor(duration / hourDuration()) -
