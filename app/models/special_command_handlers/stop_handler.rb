...
class SpecialCommandHandlers::StopHandler < SpecialCommandHandlers::Base
  def handle_command
    ...
    msg = "Ok, you won't receive any more texts from us. To change your contact preferences, log into HEngage.com and click Settings, or email support@hengage.com."
