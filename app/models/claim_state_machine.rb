  ...
  module PredefinedMachines
    ...
    MICHELIN_STYLE = {
      1 => ClaimState.new(
        ...
        already_claimed_message: "It looks like you're already signed up. Please contact support@hengage.com if you need help."
      ),
      ...
      3 => ClaimState.new(
        ...
        next_state_on_ambiguity_id: 3, 
        unrecognized_information_message: "Sorry, I don't recognize that. Please try sending your (or your spouse's) CHORUS ID for help, or contact support@hengage.com for help.", 
        valid_format: /^\d{8}$/, 
