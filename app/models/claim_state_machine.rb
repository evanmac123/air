  ...
  module PredefinedMachines
    COVIDIEN_THREE_STEP_STYLE = {
      ...
      2 => ClaimState.new(
        ...
        unrecognized_information_message: "Sorry, I don't recognize that ZIP code. Please try a different one, or contact support@air.bo for help.",
        already_claimed_message:          "It looks like that account is already claimed. Please try a different ZIP code, or contact support@air.bo for help."
      ),
    ...
    DEFAULT_STYLE = {
      1 => ClaimState.new(
        ...
        unrecognized_information_message: "I can't find you in my records. Did you claim your account yet? If not, send your first initial and last name (if you are John Smith, send \"jsmith\").",
        already_claimed_message:          "It looks like that account is already claimed. Please try again, or contact support@air.bo for help.",
        ambiguity_message:                "Sorry, we're having a little trouble, it looks like we'll have to get a human involved. Please contact support@air.bo for help joining the game. Thank you!"
      )
    }
    ...
    MICHELIN_STYLE = {
      1 => ClaimState.new(
        ...
        already_claimed_message: "It looks like you're already signed up. Please contact support@air.bo if you need help."
      ),
      ...
      3 => ClaimState.new(
        ...
        next_state_on_ambiguity_id: 3, 
        unrecognized_information_message: "Sorry, I don't recognize that. Please try sending your (or your spouse's) CHORUS ID for help, or contact support@air.bo for help.", 
        valid_format: /^\d{8}$/, 
