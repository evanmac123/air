...
describe Query::TotalViews do
  ...
  context "Weekly interval" do
    ...
    it "should return aggregated tile viewings data" do
      ...
      # Query::TotalViews.new(tile, period).query.should ==
      #   {
      #     Time.parse("2015-09-14 00:00:00 UTC")=>3,
      #     Time.parse("2015-09-15 00:00:00 UTC")=>5,
      #     Time.parse("2015-09-16 00:00:00 UTC")=>1,
      #     Time.parse("2015-09-18 00:00:00 UTC")=>10
      #   }
    end
  end

  # context "Weekly interval" do
  #   let!(:period) { Period.new 'weekly', "9/1/2015", "9/18/2015" } # american format
  #
  #   before do
  #     [
  #       [Time.new(2015, 9, 14, 0, 10, 0, "+00:00"), 3],
