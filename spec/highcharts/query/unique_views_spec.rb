...
describe Query::UniqueViews do
  ...
  context "Hourly interval" do
    ...
    before do
      [
        Time.new(2015, 9, 18, 0, 10, 0, "+00:00"),
        Time.new(2015, 9, 18, 10, 20, 0, "+00:00"),
        Time.new(2015, 9, 18, 15, 59, 0, "+00:00"),
        Time.new(2015, 9, 18, 23, 35, 0, "+00:00"),
        Time.new(2015, 9, 18, 23, 37, 0, "+00:00"),
        # bad dates:
        Time.new(2015, 9, 17, 23, 59, 0, "+00:00"),
        Time.new(2015, 9, 19, 0, 1, 0, "+00:00")
      ].each do |created_at|
        FactoryGirl.create :tile_viewing, tile: tile, created_at: created_at
      end
    end
  ...
  context "Daily interval" do
    ...
    before do
      [
        Time.new(2015, 9, 14, 0, 10, 0, "+00:00"),
        Time.new(2015, 9, 15, 10, 20, 0, "+00:00"),
        Time.new(2015, 9, 16, 15, 59, 0, "+00:00"),
        Time.new(2015, 9, 18, 23, 35, 0, "+00:00"),
        Time.new(2015, 9, 18, 23, 37, 0, "+00:00"),
        # bad dates:
        Time.new(2015, 9, 13, 23, 59, 0, "+00:00"),
        Time.new(2015, 9, 19, 0, 1, 0, "+00:00")
      ].each do |created_at|
        FactoryGirl.create :tile_viewing, tile: tile, created_at: created_at
      end
  ...
  context "Weekly interval" do
    ...
    before do
      [
        Time.new(2015, 9, 13, 0, 10, 0, "+00:00"),
        Time.new(2015, 9, 14, 10, 20, 0, "+00:00"),
        Time.new(2015, 9, 17, 15, 59, 0, "+00:00"),
        Time.new(2015, 9, 20, 23, 35, 0, "+00:00"),
        Time.new(2015, 9, 26, 23, 37, 0, "+00:00"),
        # bad dates:
        Time.new(2015, 9, 12, 23, 59, 0, "+00:00"),
        Time.new(2015, 9, 27, 23, 59, 0, "+00:00"),
        Time.new(2015, 9, 28, 0, 1, 0, "+00:00")
      ].each do |created_at|
        FactoryGirl.create :tile_viewing, tile: tile, created_at: created_at
      end
    end
  ...
  context "Montly interval" do
    ...
    before do
      [
        Time.new(2015, 8, 14, 0, 10, 0, "+00:00"),
        Time.new(2015, 8, 15, 10, 20, 0, "+00:00"),
        Time.new(2015, 9, 16, 15, 59, 0, "+00:00"),
        Time.new(2015, 10, 1, 23, 35, 0, "+00:00"),
        Time.new(2015, 10, 18, 23, 37, 0, "+00:00"),
        # bad dates:
        Time.new(2015, 8, 13, 23, 59, 0, "+00:00"),
        Time.new(2015, 10, 19, 0, 1, 0, "+00:00")
      ].each do |created_at|
        FactoryGirl.create :tile_viewing, tile: tile, created_at: created_at
      end
    end
