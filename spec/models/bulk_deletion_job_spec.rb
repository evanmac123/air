...
describe BulkUserDeletionJob do
  ...
  before do
    ...
    FactoryBot.create_list(:board_membership, 9, demo: @demo)
    FactoryBot.create_list(:board_membership, 2, is_client_admin: true,demo: @demo)
    FactoryBot.create_list(:board_membership, 2,demo: @other_demo)
  end
  ...
  context "all users" do
    before do
      FactoryBot.create(:user, is_site_admin: true, demo: @demo)
