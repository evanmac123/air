...
describe Report::Activity do
  describe "report_csv" do
    it "should return the expected data, cleaned of user's names" do
      ...
      Factory :act, :demo => @demo, :user => @user1, :text => "is now a fan of Major League Football", :inherent_points => 3, :created_at => Chronic.parse("5/3/2010 9:17PM")
...
2010-05-03,21,17,#{@user1.id},is now a fan of someone,3,,#{@user1.points},#{@user1.top_level_index}
