...
describe Tile::LinkTrackingConcern do
  let(:trackable_tile) { FactoryGirl.build(:tile, activated_at: Tile::LinkTrackingConcern::TILE_LINK_TRACKING_RELEASE_DATE) }
  ...
  describe "#has_link_tracking?" do
    ...
    it "returns false if the tile was activated before the TILE_LINK_TRACKING_RELEASE_DATE" do
      untrackable_tile = FactoryGirl.build(:tile, activated_at: Tile::LinkTrackingConcern::TILE_LINK_TRACKING_RELEASE_DATE - 1.day)
  ...
  describe "TILE_LINK_TRACKING_RELEASE_DATE" do
    it "is the correct date" do
      expect(Tile::LinkTrackingConcern::TILE_LINK_TRACKING_RELEASE_DATE).to eq("2017-09-28".to_date)
    end
  end
end
